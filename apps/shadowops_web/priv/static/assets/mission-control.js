...
const webMcpEndpoints = [
  ...
  ["shadowops_jobs", "Read the bounded persistent job queue state.", "/api/jobs"],
  ...
  ["shadowops_integrations", "Read the evidence-backed integration and source catalog.", "/api/integrations"],
  ["shadowops_connectors", "Read external connector state without changing it.", "/api/connectors"],
  ["shadowops_evidence", "Read privacy-safe evidence artifact metadata.", "/api/evidence"],
  ["shadowops_focus", "Read the configured learning and focus plan.", "/api/learning/plan"],
